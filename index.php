...
<head>
  ...
  <title>Stationerss | Online Store for Latest Stationary</title>
...
<body>
  ...
  <section>
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Pencils</h3>
      <div class="row">

        <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='Pencil' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
    ...
    <div class="container mt-5 my-section">
      <h3 class="py-4">Pens</h3>
      <div class="row">

      <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='Pens' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
