...
// FECTH PRODUCTS
$sql = "SELECT * from products WHERE category = 'Sharpner'";
$query = $db->prepare($sql);
$query->execute();
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <a href="Sharpners.php?add=<?php echo $result->id; ?>" class="btn btn-dark mt-2">Add To Cart</a>
                </div>
              </div>
            </div>
        <?php }
